...
{
  // 가속도 공분산
  // 대각 성분(0, 4, 8)에 아주 작은 양수 할당
  std::fill(imu_msgs_.linear_acceleration_covariance.begin(), 
            imu_msgs_.linear_acceleration_covariance.end(), 0.0);
  imu_msgs_.linear_acceleration_covariance[0] = 0.0001; 
  imu_msgs_.linear_acceleration_covariance[4] = 0.0001;
  imu_msgs_.linear_acceleration_covariance[8] = 0.0001;

  // 각속도 공분산
  std::fill(imu_msgs_.angular_velocity_covariance.begin(), 
            imu_msgs_.angular_velocity_covariance.end(), 0.0);
  ...
  // 방향 공분산
  std::fill(imu_msgs_.orientation_covariance.begin(), 
            imu_msgs_.orientation_covariance.end(), 0.0);
  imu_msgs_.orientation_covariance[0] = 0.001; // Roll
  imu_msgs_.orientation_covariance[4] = 0.001; // Pitch
  imu_msgs_.orientation_covariance[8] = 0.001; // Yaw
}
